...
import { IProfesorPost } from '../interfaces/IProfesor.interface';
...
export class RegistroPage implements OnInit {
  ...
  register() {
    ...
    this.DataService.GetProfesorByRut(rut).subscribe(respu => {
      ...
      this.DataService.GetProfesorByRut(rut).subscribe(resp => {
        this.userdata = resp;
        ...
        this.DataService.addProfesor(this.profesor).subscribe(response => {
